...
# gen fcl
gen_fcl="prodmarley_nue_cc_gkvm_dune10kt_1x2x2"
...
submit_file="${output_folder}submit_pointing_test_gkvm_cc-from${first}to${last}.sub"
...
JOBNAME             = pointing_test_gkvm_cc-from${first}to${last}
